...
public interface HashMapInterface<K, V> {
     ...
     *
     * In the case of a collision, use either external chaining  or linear
     * probing as a resolution strategy.
     *
     ...
     * it, I would regrow at the start of the next add operation (even if it
     ...
     *
     * When using an external chain, always add to the front of the chain when
     * possible.
     *
